...
public class Estados : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            if (this.gameObject.name == "1(Clone)" || this.gameObject.name == "2(Clone)" || this.gameObject.name == "3(Clone)")
            {
                if (other.gameObject.name == "gatling_proyectile 1(Clone)")
                {
                    Daño(8);
                }
            }else if (this.gameObject.name == "4(Clone)" || this.gameObject.name == "5(Clone)" || this.gameObject.name == "6(Clone)")
            {
                if (other.gameObject.name == "gatling_proyectile(Clone)")
                {
                    Daño(8);
                }
            }
